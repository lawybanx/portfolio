    ...
    <div className='max-w-4xl mx-auto w-full p-8' id='contact'>
        ...
        <div className='flex flex-wrap lg:justify-between -mx-4'>
          <div className='w-full lg:w-1/2 xl:w-6/12 px-4'>
            <div className='max-w-[570px] mb-12 lg:mb-0'>
              <span className='block text-xl mb-4 text-primary font-semibold'>
                Contact Me
              </span>
      ...
      <div className='mt-8 text-center'>
        <div className='flex gap-2 justify-center py-2'>
          <a
            href='www.linkedin.com/in/muhammad-awwal-bankole-069413230'
            target='_blank'
          ...
          <a
            href='https://www.github.com/lawybanx'
            target='_blank'
            rel='noopener noreferrer'
            className='text-gray-700 hover:text-white transition duration-300 ease-in-out'
          >
          ...
          <a
            href='https://www.twitter.com/awwal__'
            target='_blank'
            rel='noopener noreferrer'
            className='text-gray-700 hover:text-white transition duration-300 ease-in-out'
          >
